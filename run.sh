...
gcc -m32 -I lib/kernel/ -I lib/ -I kernel/ -fno-stack-protector  -c ./kernel/lancer.c -o build/lancer.o &&				
gcc -m32 -I lib/kernel/ -I lib/ -I kernel/  -fno-stack-protector  -c ./kernel/interrupt.c -o build/interrupt_c.o &&
gcc -m32 -I lib/kernel/ -I lib/ -I kernel/   -fno-stack-protector  -c ./kernel/init.c -o build/init.o  &&
